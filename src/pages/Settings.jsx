...
const COLOR_PRESETS = [
    {
        name: "Aurora Night",
        preview: "linear-gradient(to right top, #0f172a 0%, #1d4ed8 40%, #8b5cf6 100%)",
        colors: {
            theme_sidebar: "linear-gradient(to right top, #0f172a 0%, #111827 100%)",
    ...
    {
        name: "Ocean Pulse",
        preview: "linear-gradient(to right top, #0ea5e9 0%, #14b8a6 50%, #22d3ee 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #ecfeff 0%, #e0f2fe 55%, #cffafe 100%)",
    ...
    {
        name: "Sunset Glow",
        preview: "linear-gradient(to right top, #fb7185 0%, #f97316 45%, #fbbf24 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #fff7ed 0%, #fff1f2 50%, #fde68a 100%)",
    ...
    {
        name: "Emerald Luxe",
        preview: "linear-gradient(to right top, #10b981 0%, #14b8a6 45%, #22d3ee 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #ecfdf5 0%, #d1fae5 50%, #ccfbf1 100%)",
    ...
    {
        name: "Violet Haze",
        preview: "linear-gradient(to right top, #8b5cf6 0%, #c084fc 45%, #ec4899 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #f5f3ff 0%, #fdf2f8 45%, #eef2ff 100%)",
    ...
    {
        name: "Slate Calm",
        preview: "linear-gradient(to right top, #334155 0%, #64748b 45%, #cbd5e1 100%)",
        colors: {
    ...
    {
        name: "Rose Quartz",
        preview: "linear-gradient(to right top, #f472b6 0%, #fb7185 40%, #f9a8d4 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #fff1f2 0%, #fdf2f8 55%, #fce7f3 100%)",
    ...
    {
        name: "Forest Drift",
        preview: "linear-gradient(to right top, #15803d 0%, #22c55e 40%, #84cc16 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #f0fdf4 0%, #dcfce7 50%, #bbf7d0 100%)",
    ...
    {
        name: "Signal Tech",
        preview: "linear-gradient(to right top, #111827 0%, #2563eb 40%, #06b6d4 100%)",
        colors: {
    ...
    {
        name: "Lunar Mist",
        preview: "linear-gradient(to right top, #1e293b 0%, #6d28d9 42%, #a78bfa 100%)",
        colors: {
            ...
            theme_background: "linear-gradient(to right top, #f8fafc 0%, #eef2ff 50%, #e0e7ff 100%)",
            theme_content: "linear-gradient(to right top, #ffffff 0%, #f8fafc 100%)",
    ...
    {
        name: "Peach Bloom",
        preview: "linear-gradient(to right top, #fdba74 0%, #fb7185 42%, #f472b6 100%)",
        colors: {
            theme_sidebar: "linear-gradient(to right top, #431407 0%, #9a3d2a 100%)",
            theme_navbar: "linear-gradient(to right top, #9a3d2a 0%, #d946ef 100%)",
            theme_background: "linear-gradient(to right top, #fff7ed 0%, #ffe4e6 55%, #fdf2f8 100%)",
            theme_content: "linear-gradient(to right top, #ffffff 0%, #fff7ed 100%)",
            theme_footer: "linear-gradient(to right top, #fed7aa 0%, #fbcfe8 100%)",
            theme_primary: "#f97316",
            theme_primary_hover: "#ea580c",
            theme_secondary: "#f472b6",
            theme_secondary_hover: "#ec4899",
            theme_success: "#34d399",
            theme_success_hover: "#10b981",
            theme_info: "#f59e0b",
            theme_info_hover: "#d97706",
            theme_warning: "#fb7185",
            theme_warning_hover: "#f43f5e",
            theme_danger: "#ef4444",
            theme_danger_hover: "#dc2626",
            theme_text: "#4b1d1d",
            theme_text_secondary: "#7c2d12",
            theme_text_muted: "#9a3d2a",
            theme_border: "#fdba74",
            theme_active: "#fb7185"
        }
    },
    {
        name: "Midnight Bloom",
        preview: "linear-gradient(to right top, #020617 0%, #312e81 45%, #c084fc 100%)",
        colors: {
            theme_sidebar: "linear-gradient(to right top, #020617 0%, #111827 100%)",
            theme_navbar: "linear-gradient(to right top, #1e1b4b 0%, #4f46e5 100%)",
            theme_background: "linear-gradient(to right top, #0f172a 0%, #1e1b4b 52%, #312e81 100%)",
            theme_content: "linear-gradient(to right top, #111827 0%, #1f2937 100%)",
            theme_footer: "linear-gradient(to right top, #1f2937 0%, #312e81 100%)",
            theme_primary: "#8b5cf6",
            theme_primary_hover: "#7c3aed",
            theme_secondary: "#c084fc",
            theme_secondary_hover: "#a855f7",
    ...
    {
        name: "Mint Air",
        preview: "linear-gradient(to right top, #bbf7d0 0%, #22c55e 35%, #2dd4bf 100%)",
        colors: {
            theme_sidebar: "linear-gradient(to right top, #052e16 0%, #166534 100%)",
            theme_navbar: "linear-gradient(to right top, #14532d 0%, #14b8a6 100%)",
            theme_background: "linear-gradient(to right top, #ecfdf5 0%, #d1fae5 48%, #cffafe 100%)",
            theme_content: "linear-gradient(to right top, #ffffff 0%, #f0fdfa 100%)",
            theme_footer: "linear-gradient(to right top, #bbf7d0 0%, #a7f3d0 100%)",
            theme_primary: "#22c55e",
            theme_primary_hover: "#16a34a",
            theme_secondary: "#2dd4bf",
            theme_secondary_hover: "#14b8a6",
            theme_success: "#4ade80",
            theme_success_hover: "#22c55e",
            theme_info: "#14b8a6",
            theme_info_hover: "#0f766e",
    ...
    {
        name: "Electric Sky",
        preview: "linear-gradient(to right top, #38bdf8 0%, #3b82f6 35%, #6366f1 100%)",
        colors: {
            theme_sidebar: "linear-gradient(to right top, #082f49 0%, #1d4ed8 100%)",
            theme_navbar: "linear-gradient(to right top, #0f172a 0%, #2563eb 100%)",
            theme_background: "linear-gradient(to right top, #f0f9ff 0%, #dbeafe 50%, #e0e7ff 100%)",
            theme_content: "linear-gradient(to right top, #ffffff 0%, #eff6ff 100%)",
            theme_footer: "linear-gradient(to right top, #dbeafe 0%, #c7d2fe 100%)",
            theme_primary: "#3b82f6",
            theme_primary_hover: "#2563eb",
            theme_secondary: "#6366f1",
            theme_secondary_hover: "#4f46e5",
            theme_success: "#22c55e",
            theme_success_hover: "#16a34a",
            theme_info: "#38bdf8",
            theme_info_hover: "#0ea5e9",
